...
Revision ID: 5ebdde428e4f
Revises: 
Create Date: 2024-11-05 21:12:01.120841
...
def upgrade():
    ...
    sa.Column('game_style', sa.Enum('NARRATIVE', 'COMBAT', 'EXPLORATION', 'MIXED', name='gamestyleenum'), nullable=False),
    sa.Column('tone', sa.Enum('LIGHTHEARTED', 'SERIOUS', 'DARK', 'HUMOROUS', name='toneenum'), nullable=False),
    sa.Column('difficulty', sa.Enum('EASY', 'MEDIUM', 'HARD', 'EXPERT', name='difficultyenum'), nullable=False),
    sa.Column('theme', sa.Enum('FANTASY', 'SCIFI', 'HORROR', 'MODERN', 'HISTORICAL', name='themeenum'), nullable=False),
    ...
    sa.Column('character_id', sa.Integer(), nullable=False),
    sa.Column('save_time', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['character_id'], ['characters.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'game_name', name='uq_user_game')
    )
    ...
    sa.ForeignKeyConstraint(['game_id'], ['saved_games.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('game_id', 'order', name='uq_game_order')
    )
